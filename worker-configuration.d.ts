...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SUPERSERVE_SANDBOX_HOST: string;
		SUPERSERVE_BASE_URL: string;
		SUPERSERVE_EGRESS_ALLOW: string;
		SUPERSERVE_PREVIEW_TIMEOUT_SECONDS: string;
